...
public class Excel_Reader
{
	...
	// To locate the sheet 
	   ...
	   String data = sh1.getRow(4).getCell(1).getStringCellValue();
		...
		System.out.println("no of rows"+rowcount);  // 19 it will return last ind position
		
		
	    int columncount = sh1.getRow(5).getLastCellNum();
		System.out.println("no of column count:"+columncount);  // 2 actual count will be return
